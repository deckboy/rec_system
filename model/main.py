...
# initialize
local_ps = PS(config['embedding_dim'])  # param server
train_metric = AUCUtil()  # train metric
test_metric = AUCUtil()  # test metric
inputs = InputFn(local_ps, config)  # input
